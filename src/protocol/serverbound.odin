...
read_use_entity :: proc(r: ^Buffer_Reader) -> (Use_Entity, Protocol_Recv_Error) {
	...
	if e1 != nil { return {}, e1 }
	out := Use_Entity{target = target, type = type_id}
	if type_id == 2 {
		x, e2 := read_float(r)
		if e2 != nil { return {}, e2 }
		y, e3 := read_float(r)
...
read_player_position_and_look :: proc(r: ^Buffer_Reader) -> (Player_Position_And_Look, Protocol_Recv_Error) {
	x, e0 := read_double(r)
	if e0 != nil { return {}, e0 }
	feet_y, e1 := read_double(r)
	if e1 != nil { return {}, e1 }
...
read_player_block_placement :: proc(r: ^Buffer_Reader) -> (Player_Block_Placement, Protocol_Recv_Error) {
...
read_update_sign :: proc(r: ^Buffer_Reader) -> (Update_Sign, Protocol_Recv_Error) {
	...
	if e4 != nil { return {}, e4 }
	return Update_Sign{location = location, text1 = text1, text2 = text2, text3 = text3, text4 = text4}, nil
}
...
read_plugin_message :: proc(r: ^Buffer_Reader, allocator: mem.Allocator) -> (Plugin_Message, Protocol_Recv_Error) {
...
read_resource_pack_status :: proc(r: ^Buffer_Reader) -> (Resource_Pack_Status, Protocol_Recv_Error) {
